...
const purchaseOrderSchema=new Schema({
  ...
  status:{type:String,enum:['draft','pending','approved','rejected','sent','partially_received','received','closed_short','closed','cancelled'],default:'draft',index:true},
  ...
  rejectedBy:{...oid,ref:'User'},
  rejectedAt:Date,
  rejectionReason:{type:String,trim:true,maxlength:1000},closedBy:{...oid,ref:'User'},closedAt:Date,closeNote:{type:String,trim:true,maxlength:1000},
